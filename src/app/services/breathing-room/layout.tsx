...
export const metadata: Metadata = {
  ...
  description:
    'Mat Pilates, Yoga, Mobility, Breathwork and Yin classes at TAVÚ, Al Raha, Abu Dhabi. Drop-in 120 AED, 5-class pack 550 AED, Unlimited 3-Month Membership 2,400 AED.',
  keywords: [
